...
void mean(){
  ...
  for(int ii = 0; ii < SIZE_PA; ii++){
	...
	meanTanLambda[i][ii] = fit1->GetParameter(1);
	error_meanTanLambda[i][ii] =  fit1->GetParError(1);
      
	hPhi->Fit("gaus");
	TF1 *fit1 = (TF1*)hPhi->GetFunction("gaus");
	meanPhi[i][ii] = fit1->GetParameter(1);
	error_meanPhi[i][ii] =  fit1->GetParError(1);
	
	hd0->Fit("gaus");
	TF1 *fit1 = (TF1*)hd0->GetFunction("gaus");
	meand0[i][ii] = fit1->GetParameter(1);
	error_meand0[i][ii] =  fit1->GetParError(1);
	
	hz0->Fit("gaus");
	TF1 *fit1 = (TF1*)hz0->GetFunction("gaus");
	meanz0[i][ii] = fit1->GetParameter(1);
	error_meanz0[i][ii] =  fit1->GetParError(1);
    ...
    TGraphErrors* Muon_plot10  = new TGraphErrors(SIZE_M, Momentum, meanOmega10, zeros, errorOmega10);
    ...
    Muon_plot10 -> GetYaxis() -> SetTitle("#mean = f(P,#theta)");
    Muon_plot10 -> SetMinimum( -2. );
    Muon_plot10 -> SetMaximum( 2. );
    Muon_plot10 -> Draw("AP");
    
    
    TGraphErrors* Muon_plot20  = new TGraphErrors(SIZE_M, Momentum, meanOmega20, zeros, errorOmega20);
    Muon_plot20 -> SetMarkerColor(4);
    Muon_plot20 -> SetMarkerStyle(22);
    Muon_plot20 -> SetMarkerSize(1);
    Muon_plot20 -> Draw("P");
  
    TGraphErrors *Muon_plot40 = new TGraphErrors(SIZE_M, Momentum, meanOmega40,  zeros, errorOmega40);
    Muon_plot40 -> SetMarkerColor(2);
    Muon_plot40 -> SetMarkerStyle(21);
    Muon_plot40 -> SetMarkerSize(1);
    Muon_plot40 -> Draw("P");
    
    TGraphErrors *Muon_plot85 = new TGraphErrors(SIZE_M, Momentum, meanOmega85,  zeros, errorOmega85);
    ...
    c_two->cd(2);
    TGraphErrors* Muon_plot10  = new TGraphErrors(SIZE_M, Momentum, meanTanLambda10, zeros, errorTanLambda10);
    ...
    Muon_plot10 -> GetYaxis() -> SetTitle("#mean = f(P,#theta)");
    Muon_plot10 -> SetMinimum( -2. );
    Muon_plot10 -> SetMaximum( 2.00 );
    Muon_plot10 -> Draw("AP");
    
    
    TGraphErrors* Muon_plot20  = new TGraphErrors(SIZE_M, Momentum, meanTanLambda20, zeros, errorTanLambda20);
    Muon_plot20 -> SetMarkerColor(4);
    Muon_plot20 -> SetMarkerStyle(22);
    Muon_plot20 -> SetMarkerSize(1);
    Muon_plot20 -> Draw("P");
    
    TGraphErrors *Muon_plot40 = new TGraphErrors(SIZE_M, Momentum, meanTanLambda40,  zeros, errorTanLambda40);
    Muon_plot40 -> SetMarkerColor(2);
    Muon_plot40 -> SetMarkerStyle(21);
    Muon_plot40 -> SetMarkerSize(1);
    Muon_plot40 -> Draw("P");
    
    TGraphErrors *Muon_plot85 = new TGraphErrors(SIZE_M, Momentum, meanTanLambda85,  zeros, errorTanLambda85);
    Muon_plot85 -> SetMarkerColor(1);
    Muon_plot85 -> SetMarkerStyle(20);
    Muon_plot85 -> SetMarkerSize(1);
    Muon_plot85 -> Draw("P");
    ...
    c_two->cd(3);
    TGraphErrors* Muon_plot10  = new TGraphErrors(SIZE_M, Momentum, meanPhi10, zeros, errorPhi10);
    ...
    TGraphErrors* Muon_plot20  = new TGraphErrors(SIZE_M, Momentum, meanPhi20, zeros, errorPhi20);
    Muon_plot20 -> SetMarkerColor(4);
    Muon_plot20 -> SetMarkerStyle(22);
    Muon_plot20 -> SetMarkerSize(1);
    Muon_plot20 -> Draw("P");
  
    TGraphErrors *Muon_plot40 = new TGraphErrors(SIZE_M, Momentum, meanPhi40,  zeros, errorPhi40);
    Muon_plot40 -> SetMarkerColor(2);
    Muon_plot40 -> SetMarkerStyle(21);
    Muon_plot40 -> SetMarkerSize(1);
    Muon_plot40 -> Draw("P");
    
    TGraphErrors *Muon_plot85 = new TGraphErrors(SIZE_M, Momentum, meanPhi85,  zeros, errorPhi85);
    Muon_plot85 -> SetMarkerColor(1);
    Muon_plot85 -> SetMarkerStyle(20);
    Muon_plot85 -> SetMarkerSize(1);
    Muon_plot85 -> Draw("P");
    ...
    TGraphErrors* Muon_plot10  = new TGraphErrors(SIZE_M, Momentum, meand010, zeros, errord010);
    ...
    TGraphErrors* Muon_plot20  = new TGraphErrors(SIZE_M, Momentum, meand020, zeros, errord020);
    Muon_plot20 -> SetMarkerColor(4);
    Muon_plot20 -> SetMarkerStyle(22);
    Muon_plot20 -> SetMarkerSize(1);
    ...
    TGraphErrors *Muon_plot40 = new TGraphErrors(SIZE_M, Momentum, meand040,  zeros, errord040);
    Muon_plot40 -> SetMarkerColor(2);
    Muon_plot40 -> SetMarkerStyle(21);
    Muon_plot40 -> SetMarkerSize(1);
    Muon_plot40 -> Draw("P");
    
    TGraphErrors *Muon_plot85 = new TGraphErrors(SIZE_M, Momentum, meand085,  zeros, errord085);
    Muon_plot85 -> SetMarkerColor(1);
    Muon_plot85 -> SetMarkerStyle(20);
    Muon_plot85 -> SetMarkerSize(1);
    Muon_plot85 -> Draw("P");
    ...
    c_two->cd(5);
    TGraphErrors* Muon_plot10  = new TGraphErrors(SIZE_M, Momentum, meanz010, zeros, errorz010);
    ...
    TGraphErrors* Muon_plot20  = new TGraphErrors(SIZE_M, Momentum, meanz020, zeros, errorz020);
    Muon_plot20 -> SetMarkerColor(4);
    Muon_plot20 -> SetMarkerStyle(22);
    Muon_plot20 -> SetMarkerSize(1);
    Muon_plot20 -> Draw("P");
    
    TGraphErrors *Muon_plot40 = new TGraphErrors(SIZE_M, Momentum, meanz040,  zeros, errorz040);
    Muon_plot40 -> SetMarkerColor(2);
    Muon_plot40 -> SetMarkerStyle(21);
    Muon_plot40 -> SetMarkerSize(1);
    Muon_plot40 -> Draw("P");
    
    TGraphErrors *Muon_plot85 = new TGraphErrors(SIZE_M, Momentum, meanz085,  zeros, errorz085);
    Muon_plot85 -> SetMarkerColor(1);
    Muon_plot85 -> SetMarkerStyle(20);
    Muon_plot85 -> SetMarkerSize(1);
    Muon_plot85 -> Draw("P");
