...
void meanL5(){
  ...
  for(int ii = 0; ii < SIZE_PA; ii++){
    for (int i = 0; i < SIZE_M; i++){
      TFile *f1 = new TFile(Form("../Results/Analysis/analysis_ILD_l5_v02_v01-19-05_MuonsAngle_%d_Mom_%d.root",PA[ii],Mom[i]), "read");
    ...
    Muon_plot_omega10 -> SetMaximum( 0.50 );
    ...
    Muon_plot_tanlambda10 -> SetMaximum( 0.50 );
    ...
    Muon_plot_phi10 -> SetMaximum( 0.50 );
    ...
    Muon_plot_d010 -> SetMaximum( 0.50 );
    ...
    Muon_plot_z010 -> SetMaximum( 0.50 );
    ...
    c_two->SaveAs("pull_mean_ILD_l5_v02_v01-19-05.png");
