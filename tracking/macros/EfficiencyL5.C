void EfficiencyL5() {
  ...
  TFile* fttbar = new TFile(
      "../Results/Analysis/ILD_l5_v02/analysis_ILD_l5_v02_E0500-TDR_ws.Pyycyyc.Gwhizard-1.95.eR.pL.I36919.05.root");
  ...
  */
  ...
  if (TEfficiency::CheckConsistency(*h_reconstructed_theta_noOverlay, *h_reconstructable_theta_noOverlay)) {
    h_efficiency_theta_noOverlay =
        new TEfficiency(*h_reconstructed_theta_noOverlay, *h_reconstructable_theta_noOverlay);
  }
