...
bool WWZZProcessor::passesSelectionCriteria(Observables& observ) {
  ...
  return pass_isolep && pass_jetcharged && pass_jetparticles && pass_jetE && pass_y34 && pass_missmass &&
         pass_cosThetamiss && pass_ETvis && pass_pTvis && pass_cosThetaEmax && pass_coneEmax;
}
