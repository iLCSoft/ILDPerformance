...
std::vector<MCParticle*> WWZZProcessor::findGenLevelNeutrinos(std::vector<MCParticle*> MCparticles) {
...
void WWZZProcessor::findAllowedVVCandidates(std::vector<std::vector<std::vector<MCParticle*>>> all_VV_candidates,
