...
float string_to_float(string str) { return strtof((str).c_str(), 0); }

void create_mjjmjjplots(string luminosity_str, string e_beam_pol_str, string p_beam_pol_str, string input_dir_base) {
  ...
  TH1* h1_WW =
      new TH1D("m_WW", "WW/ZZ separation, averaged dijet-mass; (m_{jj,1} + m_{jj,2})/2 [GeV]; Events", 70, 50, 120);
  TH1* h1_ZZ =
      new TH1D("m_ZZ", "WW/ZZ separation, averaged dijet-mass; (m_{jj,1} + m_{jj,2})/2 [GeV]; Events", 70, 50, 120);
  TH2* h2_WW = new TH2D("m_m_WW", "WW/ZZ separation, 2D of dijet-masses; m_{jj,1} [GeV];  m_{jj,2} [GeV]", 35, 50, 120,
                        35, 50, 120);
  TH2* h2_ZZ = new TH2D("m_m_ZZ", "WW/ZZ separation, 2D of dijet-masses; m_{jj,1} [GeV];  m_{jj,2} [GeV]", 35, 50, 120,
                        35, 50, 120);
  ...
  for (int i = 0; i < filenames.size(); i++) {
    ...
    float polarisation_weight = (1 + sample_e_pol * e_beam_pol) / 2 * (1 + sample_p_pol * p_beam_pol) / 2;
