...
void getPDGHistos(TH1F** hist, TTree* tree, int& pdg, int& itruecut) {
  ...
  case 0:
    ...
    break;
  case 1:
    partname = ", all charged";
    break;
  case 2:
    partname = ", all neutral";
    break;
  case 11:
    partname = ", electrons";
    break;
  ...
  case 1:
    ...
    cutmin = 1;
    cutmax = 1000000000;
    cuttitle = " with P > 1 GeV";
    break;
  case 2:
    cutname = "trueP";
    cutmin = 0;
    cutmax = 2.;
    cuttitle = " with P < 2 GeV";
    break;
  case 3:
    cutname = "trueTheta";
    cutmin = 0;
  ...
  case 5:
    ...
    cutmin = 0;
    cutmax = 0.95;
    cuttitle = " with |cos(theta)|<0.95";
    break;
  case 6:
    cutname = "truePt";
    cutmin = 0;
    cutmax = 1;
    cuttitle = " with pt < 1 GeV";
    break;
  case 7:
    cutname = "truePt";
    cutmin = 1;
    cutmax = 10;
    cuttitle = " with 1 GeV < pt < 10 GeV";
    break;
  case 8:
    cutname = "trueP";
    cutmin = 1;
    cutmax = 10;
    cuttitle = " with 1 GeV < p < 10 GeV";
    break;
  case 9:
    cutname = "trueP";
    cutmin = 3;
    cutmax = 1000000000;
    cuttitle = " with P > 3 GeV";
    break;
  }
  ...
  for (int ievt = 0; ievt < nevts; ++ievt) {
    ...
    for (int ipart = 0; ipart < truePDG->size(); ipart++) {
      truecut = (pdg == 0 || (pdg == 1 && trueCharge->at(ipart) != 0) || (pdg == 2 && trueCharge->at(ipart) == 0) ||
                 (pdg > 10 && abs(truePDG->at(ipart)) == pdg));
