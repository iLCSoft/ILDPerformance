...
void plotdEdx(const char* _filename) {
  ...
  hermTree->Draw("seenDEdx:seenP>>h2",
                 "abs(trueCharge)>0.5&&isSeen>0.7&&trueMass>0.&&seenDEdx>0.&&seenDEdx<1.e-6&&abs(truePDG)==11");
  hermTree->Draw("seenDEdx:seenP>>h3",
                 "abs(trueCharge)>0.5&&isSeen>0.7&&trueMass>0.&&seenDEdx>0.&&seenDEdx<1.e-6&&abs(truePDG)==13 ");
  hermTree->Draw("seenDEdx:seenP>>h4",
                 "abs(trueCharge)>0.5&&isSeen>0.7&&trueMass>0.&&seenDEdx>0.&&seenDEdx<1.e-6&&abs(truePDG)==211");
  hermTree->Draw("seenDEdx:seenP>>h5",
                 "abs(trueCharge)>0.5&&isSeen>0.7&&trueMass>0.&&seenDEdx>0.&&seenDEdx<1.e-6&&abs(truePDG)==321");
  hermTree->Draw("seenDEdx:seenP>>h6",
                 "abs(trueCharge)>0.5&&isSeen>0.7&&trueMass>0.&&seenDEdx>0.&&seenDEdx<1.e-6&&abs(truePDG)==2212");
