...
public:
  LayerHitCounter()
      : _area(1.), _nHits(0), _nRuns(0), _nHitsRun(0), _mu2nHitsRun(0), _nEvents(0), _nHitsEvent(0), _mu2nHitsEvent(0)

  {}

  LayerHitCounter(double area)
      : _area(area), _nHits(0), _nRuns(0), _nHitsRun(0), _mu2nHitsRun(0), _nEvents(0), _nHitsEvent(0),
        _mu2nHitsEvent(0) {}
